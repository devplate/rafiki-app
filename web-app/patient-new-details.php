                                                        ...
                                                        <div>
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-name-input">First name <span class="text-danger">*</span></label>
                                                                            <input type="text" name="patient_first_name" class="form-control" id="steparrow-gen-info-name-input" placeholder="Enter first name">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-name-input">Second name <span class="text-danger">*</span></label>
                                                                            <input type="text" name="patient_second_name" class="form-control" id="steparrow-gen-info-name-input" placeholder="Enter second name">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-name-input">Last name <span class="text-danger">*</span></label>
                                                                            <input type="text" name="patient_last_name" class="form-control" id="steparrow-gen-info-name-input" placeholder="Enter last name">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="patient_phone_number" class="form-control" id="cleave-phone" placeholder="Enter number">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                            <span class="input-group-text">+255</span>
                                                                            <input type="text" name="patient_alt_phone_number" class="form-control" id="cleave-alt-phone" placeholder="Alterative number">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <div class="mb-3">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-email-input">Email address <span class="text-danger">*</span></label>
                                                                            <input type="email" name="patient_email" class="form-control" id="steparrow-gen-info-email-input" placeholder="Enter email address">
                                                                        </div>
                                                                    </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="cleave-phone">Gender <span class="text-danger">*</span></label>
                                                                            <div class="mb-2">
                                                                                <input class="form-check-input" value="Female" type="radio" name="patient_gender" id="flexRadioDefault1">
                                                                                <label class="form-check-label" for="flexRadioDefault1"> Female </label>
                                                                            </div>
                                                                            <input class="form-check-input" value="Male" type="radio" name="patient_gender" id="flexRadioDefault2">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="cleave-phone">Birth date <span class="text-danger">*</span></label>
                                                                            <input type="text" name="patient_birth_date" class="form-control" placeholder="DD-MM-YYYY" id="cleave-date">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-5">
                                                                    <div class="mb-2">
                                                                        <label class="form-label text-muted" >Nationality <span class="text-danger">*</span></label>
                                                                        <!-- Country names and Country Name -->
                                                                        <select class="form-select" data-choices id="country" name="country">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <div class="mb-2">
                                                                        <label class="form-label text-muted" for="cleave-alt-phone">National ID <span class="text-danger">*</span></label>
                                                                        <input name="patient_national_id" type="text" class="form-control" id="cleave-alt-phone" placeholder="Enter national id">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <div class="mb-3">
                                                                        <label class="form-label text-muted" for="steparrow-gen-info-email-input">Languages <span class="text-danger">*</span></label>
                                                                        <select class="form-control" name="patient_languages" id="choices-multiple-remove-button" data-choices data-choices-removeItem name="choices-multiple-remove-button" multiple>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label text-muted" for="steparrow-gen-info-email-input">Physical address <span class="text-danger">*</span></label>
                                                                    <input type="email" name="patient_physical" class="form-control" id="steparrow-gen-info-email-input" placeholder="Enter physical address">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea name="patient_bio" style="display: none;"></textarea>
                                                                </div><!-- end card-body -->
                                                            </div>
