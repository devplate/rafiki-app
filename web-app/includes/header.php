                ...
                <form class="app-search d-none d-md-inline-flex">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg " id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="notification-list pb-3">
                                <!-- item -->
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <span class="fs-11 mb-0 text-muted">Vodacom tanzania</span>
                                        </div>
                                    </div>
                                </a>
                                <!-- item -->
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <span class="fs-11 mb-0 text-muted">Tigo Tanzania</span>
                                        </div>
                                    </div>
                                </a>
                                <!-- item -->
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <span class="fs-11 mb-0 text-muted">Devplate Creative Agency</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <!-- <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-dark rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown"  data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="position-absolute topbar-badge fs-3xs translate-middle badge rounded-pill bg-badge"><span class="notification-badge">4</span><span class="visually-hidden">unread messages</span></span>
                    </button>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php if($_SESSION["user"]["user_group"] == "root" || $_SESSION["user"]["user_group"] == "hr"){echo "assets/images/logo/icon-dark.svg";}else{ echo $_SESSION["user"]["logo"];} ?>" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <?php if ($_SESSION["user"]["user_group"] != "root"){ ?>
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo $_SESSION["user"]["first_name"]. " ".$_SESSION["user"]["last_name"] ?></span>
                                <?php }?>
                                <span class="d-none d-xl-block ms-1 fs-sm user-name-sub-text"><?php echo $_SESSION["user"]["user_group"] ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome <?php  if($_SESSION["user"]["user_group"] == "root"){echo "admin";}else{echo $_SESSION["user"]["first_name"];}?>!</h6>
