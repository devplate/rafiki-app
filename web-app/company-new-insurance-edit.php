                                                        ...
                                                        <form action="connect/database.php" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div>
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <label for="company" class="form-label text-muted">Insurance Company</label>
                                                                        <input type="text" class="form-control" placeholder="Company name" value="Bumaco Insurance Co">
                                                                    </div>

                                                                   <div class="col-sm-6">
                                                                         <label for="company" class="form-label text-muted">Insurance policy</label>
                                                                        <input type="text" class="form-control" placeholder="Add new policy" value="Compressive">
                                                                    </div>

                                                                    <div class="offset-sm-6 mb-0"></div>

                                                                    <div class="col-sm-6 mt-0">
                                                                        <label for="company" class="form-label text-muted">Registered date </label>
                                                                        <input type="date"  class="form-control" placeholder="Add new policy" value="12/12/2024">
                                                                    </div>

                                                                    <div class="col-sm-6 mt-0">
                                                                        <label for="company" class="form-label text-muted">Expired date </label>
                                                                        <input type="date" class="form-control" placeholder="Add new policy" value="12/12/2030">
                                                                    </div>
                                                                    
                                                                    <div class="col-sm-12">
                                                                        <label for="insudesc" class="form-label text-muted">Insurance description.</label>
                                                                        <textarea type="text" class="form-control" placeholder="Enter description" value="Hello this is simple explanations"></textarea>
                                                                    </div>
