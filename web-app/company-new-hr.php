                                    ...
                                    <form class="vertical-navs-step" action="connect/database.php" method="post">
                                        ...
                                        <div class="col-lg-3">
                                                <div class="nav flex-column custom-nav nav-pills" role="tablist" aria-orientation="vertical">
                                                    ...
                                                    <button class="nav-link done" id="v-pills-bill-department-tab" disabled data-bs-toggle="pill" data-bs-target="#v-pills-bill-department" type="button" role="tab" aria-controls="v-pills-bill-address" aria-selected="true">
                                                        <span class="step-title me-2">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="connect/database.php" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                        <label for="pnumber" class="form-label text-muted">Phone number <span class="text-danger">*</span></label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-text">+255</span>
                                                                            <input type="text" id="cleave-phone" class="form-control" placeholder="Enter number">
                                                                        </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-text">+255</span>
                                                                            <input type="text" id="cleave-alt-phone" class="form-control" placeholder="Alterative number">
                                                                        </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        <label class="form-label text-muted" for="steparrow-gen-info-lname-input">Email address <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="d-flex align-items-start gap-3 mt-4">
                                                                <button type="submit" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-payment-tab"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Save</button>
                                                            </div>
