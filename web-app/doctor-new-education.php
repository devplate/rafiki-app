                                                    ...
                                                    <form action="connect/database.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div>
                                                            <div class="row g-3">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="mb-3">
                                                                            <p class="text-muted">Select doctor</p>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-fname-input">University/Collage</label><input type="text" data-value name="college_uni_name" class="form-control" id="degreeTitle" placeholder="Enter University/Collage name" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-4">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-4">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-lname-input">Studied Course</label><input type="text" data-value name="studied_course" class="form-control" id="steparrow-gen-info-fname-input" placeholder="Enter studied cause" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="mb-4">
                                                                            <label for="passedYear" class="form-label text-muted">Start</label>
                                                                            <input type="text" class="form-control" data-trigger data-value name="startYear" placeholder="Year">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="mb-4">
                                                                            <label for="passedYear" class="form-label text-muted">Finish</label>
                                                                            <input type="text" class="form-control" data-trigger data-value name="finishYear" placeholder="Year">
                                                                        </div>
                                                                    </div>
