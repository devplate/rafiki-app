                                    ...
                                    <div class="row gy-5">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="nav flex-column custom-nav nav-pills" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a href="patient-new-eduction-edit.php">
                                                        ...
                                                        <div>
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <input type="text" name="patient_first_name" class="form-control" id="steparrow-gen-info-name-input" value="Adam">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-name-input">Second name </label>
                                                                            <input type="text" name="patient_second_name" class="form-control" id="steparrow-gen-info-name-input" value="Peter">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-name-input">Last name </label>
                                                                            <input type="text" name="patient_last_name" class="form-control" id="steparrow-gen-info-name-input" value="Mahendeka">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="patient_phone_number" class="form-control" id="cleave-phone" value="7328632832">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                            <span class="input-group-text">+255</span>
                                                                            <input type="text" name="patient_alt_phone_number" class="form-control" id="cleave-alt-phone" value="7487237287">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="email" name="patient_email" class="form-control" id="steparrow-gen-info-email-input" value="adampetre@gmail.comc">
                                                                        </div>
                                                                    </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <input class="form-check-input" checked value="Male" type="radio" name="patient_gender" id="flexRadioDefault2">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <input type="text" name="patient_birth_date" class="form-control" value="12-12-1990" id="cleave-date">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-7">
                                                                    <div class="mb-2">
                                                                        ...
                                                                        <input name="patient_national_id" type="text" class="form-control" id="cleave-alt-phone" value="4837430921814">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Longitudes" value="324">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Latitudes" value="329">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="email" name="patient_physical" class="form-control" id="steparrow-gen-info-email-input" value="Magomeni, Mapipa Dar es salaam">
                                                                </div>
                                                            </div>
