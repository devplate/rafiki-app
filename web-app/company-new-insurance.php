                                    ...
                                    <form class="vertical-navs-step" action="connect/database.php" method="post">
                                        ...
                                        <div class="col-lg-3">
                                                <div class="nav flex-column custom-nav nav-pills" role="tablist" aria-orientation="vertical">
                                                    ...
                                                    <button class="nav-link done" disabled id="v-pills-bill-department-tab" data-bs-toggle="pill" data-bs-target="#v-pills-bill-department" type="button" role="tab" aria-controls="v-pills-bill-address" aria-selected="true">
                                                        <span class="step-title me-2">
                                                        ...
                                                        <form action="connect/database.php" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div>
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <label for="company" class="form-label text-muted">Insurance company <span class="text-danger">*</span></label>
                                                                            <select class="form-control" data-choices name="choices-single-default" id="choices-single-default">
                                                                                <option value="">Choose from the list</option>
                                                                                <option value="Insurance one">Insurance one</option>
                                                                                <option value="Insurance two">Insurance two</option>
                                                                                <option value="Insurance three">Insurance three</option>
                                                                            </select>
                                                                    </div>

                                                                    <div class="col-sm-6">
                                                                        <label for="company" class="form-label mb-4"></label>
                                                                        <input type="text" class="form-control" placeholder="Add new policy" value="">
                                                                    </div>

                                                                    <div class="col-sm-6">
                                                                        <label for="company" class="form-label text-muted">Registered date <span class="text-danger">*</span></label>
                                                                        <input type="date"  class="form-control" placeholder="Add new policy" value="">
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <label for="company" class="form-label text-muted">Expired date <span class="text-danger">*</span></label>
                                                                        <input type="date" class="form-control" placeholder="Add new policy" value="">
                                                                    </div>
                                                                    
                                                                    <div class="col-sm-12">
                                                                        <label for="insudesc" class="form-label text-muted">Insurance description.</label>
                                                            ...
                                                            <div class="d-flex align-items-start gap-3 mt-4">
                                                                <button type="submit" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="v-pills-payment-tab"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Finish</button>
                                                            </div>
