...
function loadCharts() {
    (t = getChartColorsArray("column_chart")) && (e = {
        ...
        series: [{
            name: "Anxiety",
            data: [46, 57, 59, 54, 62, 58, 64, 60, 66, 88, 300, 70]
        }, {
            name: "Sex Dysfunction",
            data: [74, 83, 102, 97, 86, 106, 93, 114, 94, 89, 380, 90]
        }, {
            name: "Substance Abuse",
            data: [37, 42, 18, 26, 47, 50, 54, 55, 93, 89, 47, 30]
        },{
            name: "Depression",
            data: [47, 29, 80, 66, 97, 50, 254, 75, 83, 80, 100, 390]
        },{
            name: "Stress",
            data: [17, 90, 58, 26, 37, 90, 104, 155, 13, 49, 70, 130]
        },{
            name: "Aggression",
            data: [227, 52, 38, 96, 87, 70, 54, 79, 43, 39, 80, 90]
        }],
        colors: t,
        xaxis: {
