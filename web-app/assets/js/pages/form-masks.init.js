...
document.querySelector("#cleave-date") && (cleaveDate = new Cleave("#cleave-date", {
    ...
    delimiters: ["", " ", " "],
    blocks: [0, 4, 3, 3, 3]
})),document.querySelector("#cleave-hr-phone") && (cleaveBlocks = new Cleave("#cleave-hr-phone", {
    delimiters: ["", " ", " "],
    blocks: [0, 4, 3, 3, 3]
})),document.querySelector("#cleave-hr-alt-phone") && (cleaveBlocks = new Cleave("#cleave-hr-alt-phone", {
    delimiters: ["", " ", " "],
    blocks: [0, 4, 3, 3, 3]
})),document.querySelector("#cleave-alt-phone") && (cleaveBlocks = new Cleave("#cleave-alt-phone", {
    delimiters: ["", " ", " "],
    blocks: [0, 4, 3, 3, 3]
}));