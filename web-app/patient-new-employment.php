                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <form action="connect/database.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row g-3">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <p class="text-muted">Select company <span class="text-danger">*</span></p>
                                                                            <select class="form-control" data-choices name="patient_company_name" id="choices-single-default">
                                                                                <option value="">Choose from the list</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <p class="text-muted">Select department <span class="text-danger">*</span></p>
                                                                            <select class="form-control" data-choices name="patient_department_name" id="choices-single-default">
                                                                                <option value="">Choose from the list</option>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-fname-input">Job title <span class="text-danger">*</span></label>
                                                                            <input type="text" data-value name="patient_job_title" class="form-control" id="steparrow-gen-info-fname-input" placeholder="Enter job title">
                                                                        </div>
                                                                    </div>

                                                                    <div class="col-lg-6">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-sname-input">Employee ID <span class="text-danger">*</span></label>
                                                                            <input type="email" data-value name="patient_contact_second_name" class="form-control" id="steparrow-gen-info-sname-input" placeholder="Enter employee ID">
                                                                        </div>
                                                                    </div>

                                                                    <div class="col-lg-12">
                                                                        <div class="mb-2">
                                                                            <label class="form-label text-muted" for="steparrow-gen-info-lname-input">Education level <span class="text-danger">*</span></label>
                                                                            <select class="form-control" data-choices id="qualification" data-value name="qualification" id="choices-single-default">
