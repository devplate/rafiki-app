                                                    ...
                                                    <form action="connect/database.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div>
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" data-value name="doctor_phone_number" class="form-control" id="cleave-phone" placeholder="Enter number">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                            <span class="input-group-text">+255</span>
                                                                            <input type="text" data-value name="doctor_alt_phone_number" class="form-control" id="cleave-alt-phone" placeholder="Alterative number">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-5">
                                                                    <div class="mb-2">
                                                                        <label class="form-label text-muted" for="cleave-alt-phone">Nationality <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    <label class="form-label mb-3 text-muted" for="steparrow-gen-info-email-input">Biography <span class="text-danger">*</span></label>
