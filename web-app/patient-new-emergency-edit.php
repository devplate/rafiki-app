                                                        ...
                                                        <div class="row g-3">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <input type="text"  name="patient_contact_first_name" class="form-control" id="steparrow-gen-info-fname-input" value="John">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <input type="email" name="patient_contact_second_name" class="form-control" id="steparrow-gen-info-sname-input" value="Doer">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <input type="email" name="patient_contact_last_name" class="form-control" id="steparrow-gen-info-lname-input" value="Pause">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="patient_contact_phone_number" class="form-control" id="cleave-phone" value="83237529324">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                            <span class="input-group-text">+255</span>
                                                                            <input type="text" name="patient_contact_alt_phone_number" class="form-control" id="cleave-alt-phone" value="849374854023">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="patient_contact_physical" class="form-control" id="steparrow-gen-info-lname-input" value="Sinono Arusha">
                                                                        </div>
                                                                    </div>
