                                    ...
                                    <div class="row gy-5">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="nav flex-column custom-nav nav-pills" role="tablist" aria-orientation="vertical">
                                                ...
                                                <button class="nav-link active done" id="v-pills-finish-tab" disabled data-bs-toggle="pill" data-bs-target="#v-pills-finish" type="button" role="tab" aria-controls="v-pills-finish" aria-selected="false">
                                                    <span class="step-title me-2">
                                            ...
                                            <div class="px-lg-4">
                                                <div class="tab-content">
                                                    ...
                                                    <div class="text-center">
                                                            ...
                                                            <h5>Well Done !</h5>
                                                            <p class="text-muted">You have Successfully create a Patient</p>
                                                        </div>
