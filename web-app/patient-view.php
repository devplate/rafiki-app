                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless table-sm align-middle table-nowrap mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th class="ps-0 text-end" scope="row">Alt number:</th>
                                                            <td class="text-muted">+255 734 638 394</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0 text-end" scope="row">Email address:</th>
                                                            <td class="text-muted">info@vodacom.co.tz</td>
                                    ...
                                    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                                        <div class="col">
                                            <div class="card border-bottom border-3 border-secondary">
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-4"><span class="counter-value" data-target="8">0</span></h4>
                                        ...
                                        <div class="col">
                                            <div class="card border-bottom border-3 border-warning">
                                                <div class="card-body">
                                                    <span class="badge bg-danger-subtle text-danger float-end"><i class="ph-trend-down align-middle me-1"></i> 12.6%</span>
                                                    <h4 class="mb-4"><span class="counter-value" data-target="10">0</span>%</h4>

                                                    <p class="text-muted fw-medium mb-0">Health Index</p>
                                                </div>
                                            </div>
                                        </div>
