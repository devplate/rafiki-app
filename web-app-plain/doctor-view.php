        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div id="cards-here" class="col-xl-4">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="qualification" role="tabpanel">
                                    <div class="card py-3">
                                        ...
                                        <div class="card-body">
                                            <ul id="qualifications-here" class="list-unstyled mb-0">
...
<script>
    function append(response) {
        ...
        document.querySelector("#cards-here").innerHTML = response
    }
    function appendQua(response) {
        
        document.querySelector("#qualifications-here").innerHTML = response
    }
    
    var id = <?php echo $_GET["see_id"] ?>;
    fetch("https://www.rafikiapp.tz/web-app/connect/metadata.php?doctor_view=1&id="+id, {
        method: "GET",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded"
        }
    }).then((response) => response.text()).then((text) => append(text));
    fetch("https://www.rafikiapp.tz/web-app/connect/metadata.php?doc_qualifications=1", {
        method: "GET",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded"
        }
    }).then((response) => response.text()).then((text) => appendQua(text));
