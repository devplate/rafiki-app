                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="country" name="company">
                                            ...
                                            <div class="col-lg-12 mt-4 mb-2">
                                                <div class="hstack gap-2 justify-content-end">
                                                    <button type="submit" name="excel_submit" class="btn btn-primary"><i class="bi bi-upload align-baseline me-1"></i> Upload patients</button>
                                                </div>
                                            </div>
                                        </div><!--end row-->
                                    </form>
