                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="text-center mt-5 mb-5">
                                                    <div class="profile-user position-relative d-inline-block mx-auto mb-3">
                                                        ...
                                                        <div class="avatar-xs p-0 rounded-circle profile-photo-edit">
                                                            <input id="profile-img-file-input" name="doc-pic" type="file" class="profile-img-file-input" accept="image/png, image/jpeg">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" data-value name="doctor_first_name" class="form-control" id="steparrow-gen-info-name-input" placeholder="Enter first name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                            <label class="form-label" for="steparrow-gen-info-name-input">Second name <span class="text-danger">*</span></label>
                                                            <input type="text" data-value name="doctor_second_name" class="form-control" id="steparrow-gen-info-name-input" placeholder="Enter second name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                            <label class="form-label" for="steparrow-gen-info-name-input">Last name <span class="text-danger">*</span></label>
                                                            <input type="text" data-value name="doctor_last_name" class="form-control" id="steparrow-gen-info-name-input" placeholder="Enter last name">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" data-value name="doctor_phone_number" class="form-control" id="cleave-phone" placeholder="+255 xxx xxx xxxx">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                            <label class="form-label" for="cleave-alt-phone">Alternative number <span class="text-danger">*</span></label>
                                                            <input type="text" data-value name="doctor_alt_phone_number" class="form-control" id="cleave-alt-phone" placeholder="+255 xxx xxx xxxx">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                            <label class="form-label" for="steparrow-gen-info-email-input">Email address <span class="text-danger">*</span></label>
                                                            <input type="email" data-value name="doctor_email" class="form-control" id="steparrow-gen-info-email-input" placeholder="Enter email address">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="mb-2">
                                                                <input class="form-check-input" value="Female" type="radio" data-value name="doctor_gender" id="flexRadioDefault1">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" data-value name="doctor_birth_date" class="form-control" placeholder="DD-MM-YYYY" id="cleave-date">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-4">
                                                            ...
                                                            <input data-value name="doctor_national_id" type="text" class="form-control" id="cleave-alt-phone" placeholder="Enter national id">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="email" data-value name="doctor_physical" class="form-control" id="steparrow-gen-info-email-input" placeholder="Enter physical address">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-4">
                                                            ...
                                                            <textarea class="form-control" data-value name="doctor_bio" placeholder="Enter Description" id="gen-info-description-input" rows="4"></textarea>
                                                        </div><!-- end card-body -->
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="steparrow-description-info" role="tabpanel" aria-labelledby="steparrow-description-info-tab">
                                                        ...
                                                        <div id="newlink">
                                                            <div id="1">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="mb-4">
                                                                            <label class="form-label" for="steparrow-gen-info-fname-input">University/Collage</label><input type="text" data-value name="college_uni_name" class="form-control" id="degreeTitle" placeholder="Enter University/Collage name" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-4">
                                                                            <label class="form-label" for="steparrow-gen-info-sname-input">Education level</label><select class="form-select" id="qualification" data-value name="qualification">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-4">
                                                                            <label class="form-label" for="steparrow-gen-info-lname-input">Studied Course</label><input type="text" data-value name="studied_course" class="form-control" id="steparrow-gen-info-fname-input" placeholder="Enter studied cause" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="mb-4">
                                                                            <label for="passedYear" class="form-label">Start</label><select class="form-control" data-trigger data-value name="startYear">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="mb-4">
                                                                            <label for="passedYear" class="form-label">Finish</label><select class="form-control" data-trigger data-value name="finishYear">
                                                                                <option value="">Year</option>
                                                                                <option value="1970">1970</option>
                                                                                <option value="1971">1971</option>
                                                                                <option value="1972">1972</option>
                                            ...
                                            <div class="d-flex align-items-start gap-3 mt-5">
                                                ...
                                                <button type="button" onclick="submitForm()" data-value name="doctor_submit" class="btn btn-success btn-label right ms-auto no-border-radius nexttab nexttab" data-nexttab="pills-experience-tab"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Finish</button>
                                            </div>
...
<script>
    ...
    function submitForm() {
        ...
        const fileInput = document.querySelector('input[name="doc-pic"]');

        formData.append("fileInput", fileInput.files[0]);

        var doctor_first_name                     = document.querySelector('input[name="doctor_first_name"]').value;
        var doctor_second_name                      = document.querySelector('input[name="doctor_second_name"]').value;
        var doctor_last_name                      = document.querySelector('input[name="doctor_last_name"]').value;
        var doctor_phone_number                     = document.querySelector('input[name="doctor_phone_number"]').value;
        var doctor_alt_phone_number                      = document.querySelector('input[name="doctor_alt_phone_number"]').value;
        var doctor_email                      = document.querySelector('input[name="doctor_email"]').value;
        var doctor_gender                      = document.querySelector('input[name="doctor_gender"]').value;
        var doctor_birth_date                     = document.querySelector('input[name="doctor_birth_date"]').value;
        var country                     = document.querySelector('select[name="country"]').value;
        var doctor_national_id                     = document.querySelector('input[name="doctor_national_id"]').value;
        var doctor_languages                     = document.querySelector('select[name="doctor_languages"]').value;
        var doctor_physical                      = document.querySelector('input[name="doctor_physical"]').value;
        var doctor_bio                      = document.querySelector('textarea[name="doctor_bio"]').value;
        ...
        var college_uni_name                     = document.querySelector('input[name="college_uni_name"]').value;
        var qualification                     = document.querySelector('select[name="qualification"]').value;
        var studied_course                     = document.querySelector('input[name="studied_course"]').value;
        var startYear                     = document.querySelector('select[name="startYear"]').value;
        var finishYear                     = document.querySelector('select[name="finishYear"]').value;

        formData.append("doctor_first_name",      doctor_first_name                 );
        formData.append("doctor_second_name",     doctor_second_name                 );
        formData.append("doctor_last_name",       doctor_last_name                 );
        formData.append("doctor_phone_number",    doctor_phone_number                 );
        formData.append("doctor_alt_phone_number", doctor_alt_phone_number                );
        formData.append("doctor_email",           doctor_email                 );
        formData.append("doctor_gender",          doctor_gender                 );
        formData.append("doctor_birth_date",      doctor_birth_date                 );
        formData.append("country",                country                 );
        formData.append("doctor_national_id",     doctor_national_id                 );
        formData.append("doctor_languages",doctor_languages);     
        formData.append("doctor_physical",doctor_physical);        
        formData.append("doctor_bio",             doctor_bio                 );
        ...
        formData.append("college_uni_name", college_uni_name);       
        formData.append("qualification",          qualification                 );
        formData.append("studied_course",         studied_course                 );
        formData.append("startYear",              startYear                 );
        formData.append("finishYear",             finishYear                 );
        formData.append("doctor_submit", 1);

        
        let url = "";
        fetch(url.concat("https://www.rafikiapp.tz/web-app/connect/database.php"//?doctor_first_name=",
            // doctor_first_name       , "&doctor_second_name=",
            // doctor_second_name      , "&doctor_last_name=",
            // doctor_last_name        , "&doctor_phone_number=",
            // doctor_phone_number     , "&doctor_alt_phone_number=",
            // doctor_alt_phone_number , "&doctor_email=",
            // doctor_email            , "&doctor_gender=",
            // doctor_gender           , "&doctor_birth_date=",
            // doctor_birth_date       , "&country=",
            // country                 , "&doctor_national_id=",
            // doctor_national_id      , "&doctor_languages=",
            // doctor_languages        , "&doctor_physical=",
            // doctor_physical         , "&doctor_bio=",
            // doctor_bio              , "&contact_first_name=",
            // contact_first_name      , "&contact_second_name=",
            // contact_second_name     , "&contact_last_name=",
            // contact_last_name       , "&contact_phone=",
            // contact_phone           , "&alt_contact_phone=",
            // alt_contact_phone       , "&contact_relationship=",
            // contact_relationship    , "&contact_physical=",
            // contact_physical        , "&college_uni_name=", 
            // college_uni_name        , "&qualification=",
            // qualification           , "&studied_course=",
            // studied_course          , "&startYear=",
            // startYear               , "&finishYear=",
            // finishYear              , "&doctor_submit=1"
            ), {
            method: "POST",
            body: formData
